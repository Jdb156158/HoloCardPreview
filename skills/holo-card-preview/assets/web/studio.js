...
const darkTheme=document.createElement('link');darkTheme.rel='stylesheet';darkTheme.href='dark-theme.css?v=20260913d';document.head.append(darkTheme);
const darkFix=document.createElement('link');darkFix.rel='stylesheet';darkFix.href='dark-fix.css?v=20260913d';document.head.append(darkFix);
const exportScript=document.createElement('script');exportScript.src='export.js?v=20260913d';exportScript.onload=()=>{if(new URLSearchParams(location.search).get('phone')==='1'){const mobileScript=document.createElement('script');mobileScript.src='phone.js?v=20260913d';document.body.append(mobileScript);}};document.body.append(exportScript);
