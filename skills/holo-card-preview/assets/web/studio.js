...
const exportScript=document.createElement('script');exportScript.src='export.js?v=20260913c';exportScript.onload=()=>{if(new URLSearchParams(location.search).get('phone')==='1'){const mobileScript=document.createElement('script');mobileScript.src='phone.js?v=20260913c';document.body.append(mobileScript);}};document.body.append(exportScript);
