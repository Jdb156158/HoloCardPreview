...
const exportScript=document.createElement('script');exportScript.src='export.js';exportScript.onload=()=>{if(new URLSearchParams(location.search).get('phone')==='1'){const mobileScript=document.createElement('script');mobileScript.src='phone.js';document.body.append(mobileScript);}};document.body.append(exportScript);
